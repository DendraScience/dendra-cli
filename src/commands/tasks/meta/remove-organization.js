...
module.exports = ctx => {
  const { conns, mergedSettings, style, valid } = ctx
        ...
        const answers = await inquirer.prompt([
          {
            ...
            default: false,
            message:
              'Remove associated datastreams, stations, annotations, downloads, uploads, monitors and memberships',
            name: 'confirm'
          }
        ])
